<%@ Page Title="" Language="C#" MasterPageFile="~/fee/Site1.Master" AutoEventWireup="true" CodeBehind="r_modify.aspx.cs" Inherits="DB.Web.fee.r_modify" %>
                    ...
                    <div class="ibox-content">
                                ...
                                <ul class="form-horizontal m-b clearfix" style="list-style: none;">
                                   ...
                                   <div class="hr-line-dashed"></div>
                                    ...
                                    <li class="form-group clearfix">
                                        <label class="col-sm-2 control-label">是否有活动</label>
                                    ...
                                    <li class="form-group clearfix">
                                        ...
                                        <div class="col-sm-10">
                                              <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control chosen-select" >
                                                 <asp:ListItem Value="1">营业</asp:ListItem>
                                          <asp:ListItem Value="2">听课</asp:ListItem>
