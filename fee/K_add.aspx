<%@ Page Title="" Language="C#" MasterPageFile="~/fee/Site1.Master" AutoEventWireup="true" CodeBehind="K_add.aspx.cs" Inherits="DB.Web.fee.K_add" %>
                        ...
                        <ul class="form-horizontal m-b clearfix" style="list-style: none;">
                            ...
                            <li class="form-group clearfix">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="费用总额" runat="server" id="allf">
                                </div>
                            </li>
                            ...
                            <li class="form-group clearfix">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="总天数" runat="server" id="time">
                                </div>
                            </li>
