<%@ Page Title="" Language="C#" MasterPageFile="~/fee/Site1.Master" AutoEventWireup="true" CodeBehind="m_list.aspx.cs" Inherits="DB.Web.fee.m_list" %>
                                ...
                                <tbody>
                                    ...
                                    <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="t-center">
                                                 <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("atid")%>' CommandName="qd"  runat="server"  CssClass="btn btn-info btn-table-eidt" title="休学" >
                                                        <i class="fa fa-calendar-check-o"></i> 休学
                                                      </asp:LinkButton>
                                                   
                                                     <asp:LinkButton ID="LinkButton2" CommandArgument='<%#Eval("atid")%>' CommandName="qx"  runat="server"  CssClass="btn btn-info btn-table-eidt" title="取消休学" >
                                                        <i class="fa fa-calendar-check-o"></i> 取消休学
                                                      </asp:LinkButton>
