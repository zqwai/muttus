<%@ Page Title="" Language="C#" MasterPageFile="~/fee/Site1.Master" AutoEventWireup="true" CodeBehind="manage_list.aspx.cs" Inherits="DB.Web.fee.manage_list" %>
                                    ...
                                    <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%#Eval("weixinname")%></td>
                                                  <td runat="server" id="role"><%#Eval("feerole")%></td>
