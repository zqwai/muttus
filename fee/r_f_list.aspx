<%@ Page Title="" Language="C#" MasterPageFile="~/fee/Site1.Master" AutoEventWireup="true" CodeBehind="r_f_list.aspx.cs" Inherits="DB.Web.fee.r_f_list" %>
                                ...
                                <tbody>
                                    ...
                                    <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="t-center">
                                                  <a href='<%#"f_modify.aspx?id="+Eval("feedtid")%> ' class="btn btn-info btn-table-eidt" title="修改费用"  >
                                                        <i class="fa  fa-eye"></i>
                                                    </a>
