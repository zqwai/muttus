<%@ Page Title="" Language="C#" MasterPageFile="~/inventory/Site1.Master" AutoEventWireup="true" CodeBehind="category_list.aspx.cs" Inherits="DB.Web.inventory.category_list" %>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables" >
                                <thead>
                                    <tr>
                                        <th width="20%">编号</th>
                                        <th width="50%">名称</th>
                                        <th width="30%" class="t-center">操作</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="t-center">
                                                    <a href='<%#"p_modify.aspx?id="+Eval("pid")%> ' class="btn btn-info btn-table-eidt" title="修改"  >
                                                        <i class="fa  fa-eye"></i>
                                                    </a>
                                                   
                                                      <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("pid")%>' CommandName="del"  runat="server"  CssClass="btn btn-warning btn-table-eidt" title="删除" ><i class="fa fa-trash"></i> 
                                                      </asp:LinkButton>
