<%@ Page Title="" Language="C#" MasterPageFile="~/inventory/Site1.Master" AutoEventWireup="true" CodeBehind="outlist_add.aspx.cs" Inherits="DB.Web.inventory.outlist_add" %>
                    ...
                    <div class="ibox-content">
                                ...
                                <ul class="form-horizontal m-b clearfix" style="list-style: none;">
                                    ...
                                    <li class="form-group clearfix">
                                        <label class="col-sm-2 control-label">选择入库品类</label>
                                        <div class="col-sm-5">
                                    ...
                                    <li class="form-group clearfix">
                                        <label class="col-sm-2 control-label">选择入库用品名称</label>
                                        <div class="col-sm-5">
                                    ...
                                    <li class="form-group clearfix">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" name="" value="" placeholder="输入入库数量" class="form-control" runat="server" id="no">
                                        </div>
                                        <div class="col-sm-2">
