<%@ Page Title="" Language="C#" MasterPageFile="~/inventory/Site1.Master" AutoEventWireup="true" CodeBehind="outlist_list.aspx.cs" Inherits="DB.Web.inventory.outlist_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <title>出出库系统 | Mutuus管理系统</title>
    <!-- public -->
                                ...
                                <thead>
                                    <tr>
                                       <th width="5%" class="t-center">编号</th>
                                        ...
                                        <th width="7%" class="t-center">出库数量</th>
                                            ...
                                            <tr>
                                               ...
                                               <td><%#Eval("remark")%></td>
                                                <td class="t-center">
                                                      ...
                                                      <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("ck_id")%>' CommandName="del"  runat="server"  CssClass="btn btn-warning btn-table-eidt" title="删除" ><i class="fa fa-trash"></i> 
                                                      </asp:LinkButton>
