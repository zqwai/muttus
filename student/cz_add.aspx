<%@ Page Title="" Language="C#" MasterPageFile="~/student/Site1.Master" AutoEventWireup="true" CodeBehind="cz_add.aspx.cs" Inherits="DB.Web.student.cz_add" %>
                                ...
                                <ul class="form-horizontal m-b clearfix" style="list-style: none;">
                                    ...
                                    <div class="hr-line-dashed"></div>
                                        ...
                                        <div class="col-sm-10 CheckBoxList2">
                                            <asp:CheckBoxList ID="CheckBoxList2" runat="server"  RepeatColumns="5" RepeatDirection="Horizontal" RepeatLayout="Flow"></asp:CheckBoxList>
                                    ...
                                    <div class="hr-line-dashed"></div> 
                                        ...
                                        <div class="col-sm-10">
                                              ...
                                              <asp:LinkButton ID="LinkButton2" runat="server"  CssClass="btn btn-info" OnClick="LinkButton2_Click" ><i class="fa fa-backward"></i> 返回</asp:LinkButton>
