<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_cd.aspx.cs" Inherits="DB.Web.view_cd" %>
...
<ul id="elasticstack" class="elasticstack">
    <li class="flexbox">
        ...
        <article class="cont flex">
            ...
            <div class="ncont">
                 <asp:Image ID="Image1" runat="server" Width="100%" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有菜谱！" />
        ...
        <footer class="footer clearfix">
            <div class="sign-box">
                ...
                <div class="sign-text">mutuus联合创始人<br>注册国际营养师(CINM)<br>证书编号：CINM15537E28</div>
            </div>
            <div class="foot-logo">
    ...
    <li class="flexbox">
        ...
        <article class="cont flex">
            ...
            <div class="ncont">
                  <asp:Image ID="Image2" runat="server" Width="100%" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有菜谱！" />
    ...
    <li class="flexbox">
        ...
        <article class="cont flex">
            ...
            <div class="ncont">
               <asp:Image ID="Image3" runat="server" Width="100%" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有菜谱！" />
    ...
    <li class="flexbox">
        ...
        <article class="cont flex">
            ...
            <div class="ncont">
                  ...
                  <asp:Image ID="Image4" runat="server" Width="100%" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有菜谱！" />
    ...
    <li class="flexbox">
        ...
        <article class="cont flex">
            ...
            <div class="ncont">
                  <asp:Image ID="Image5" runat="server" Width="100%" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有菜谱！" />
