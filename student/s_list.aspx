<%@ Page Title="" Language="C#" MasterPageFile="~/student/Site1.Master" AutoEventWireup="true" CodeBehind="s_list.aspx.cs" Inherits="DB.Web.student.s_list" %>
                                ...
                                <tbody>
                                    ...
                                    <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="t-center">
                                                    <a href='<%#"s_modify.aspx?id="+Eval("sid")%> ' class="btn btn-info btn-table-eidt" title="审核赋权"  >
                                                        <i class="fa  fa-eye"></i>
                                                    </a>
                                                   
                                                    
                                                    
                                                      <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("sid")%>' CommandName="del"  runat="server"  CssClass="btn btn-warning btn-table-eidt" title="删除" ><i class="fa fa-trash"></i> 
                                                      </asp:LinkButton>
