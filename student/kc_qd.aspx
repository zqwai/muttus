<%@ Page Title="" Language="C#" MasterPageFile="~/student/Site1.Master" AutoEventWireup="true" CodeBehind="kc_qd.aspx.cs" Inherits="DB.Web.student.kc_qd" %>
                                            ...
                                            <tr>
                                              <td>
                                                ...
                                                <td class="t-center">
                                                      ...
                                                      <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("sid")%>' CommandName="qd"  runat="server"  CssClass="btn btn-info btn-table-eidt" title="签到" >
                                                        <i class="fa fa-calendar-check-o"></i> sign
                                                      </asp:LinkButton>
