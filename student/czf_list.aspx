<%@ Page Title="" Language="C#" MasterPageFile="~/student/Site1.Master" AutoEventWireup="true" CodeBehind="czf_list.aspx.cs" Inherits="DB.Web.student.czf_list" %>
                                            ...
                                            <tr>
                                                ...
                                                <td class="t-center">
                                                    <a href='<%#"cz_modify.aspx?id="+Eval("umbid")%> ' class="btn btn-info btn-table-eidt" title="新增目标"  >
                                                       ...
                                                       <asp:LinkButton ID="LinkButton2" CommandArgument='<%#Eval("umbid")%>' CommandName="del"  runat="server"  CssClass="btn btn-warning btn-table-eidt" title="计算评分" ><i class="fa fa-plus"></i> 
                                                      </asp:LinkButton>
