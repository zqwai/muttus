<%@ Page Title="" Language="C#" MasterPageFile="~/student/Site1.Master" AutoEventWireup="true" CodeBehind="manage_modify.aspx.cs" Inherits="DB.Web.student.manage_modify" %>
                                        ...
                                        <div class="col-sm-5">
                                            <asp:DropDownList ID="DropDownList1" runat="server">
                                                <asp:ListItem Value="0">超级管理员</asp:ListItem>
                                                   ...
                                                   <asp:ListItem Value="2">课表管理员</asp:ListItem>
                                                   <asp:ListItem Value="3">餐表管理</asp:ListItem>
