<%@ Page Title="" Language="C#" MasterPageFile="~/student/Site1.Master" AutoEventWireup="true" CodeBehind="cz_list.aspx.cs" Inherits="DB.Web.student.cz_list" %>
                                    ...
                                    <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="t-center">
                                                      ...
                                                      <a href='<%#"czall_list.aspx?id="+Eval("uid")%> ' class="btn btn-info btn-table-eidt" title="全部特征"  >
                                                       查看特征
                                                    </a>
                                                      <a href='<%#"czdate_list.aspx?id="+Eval("uid")%>' class="btn btn-info btn-table-eidt" title="数据"  >
                                                       数据
                                                    </a>
