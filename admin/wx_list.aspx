<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="wx_list.aspx.cs" Inherits="DB.Web.Admin.wx_list" %>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server"   onitemcommand="Repeater1_ItemCommand" >
                                    <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><div style="width: 99%;word-break: break-all;"><%#Eval("wxaname")%></div></td>
                                                <td><div style="width: 99%;word-break: break-all;"><%#Eval("wxurl")%></div></td>
                                             
                                                <td class="t-center">
                                                    <a href='<%#"wx_modify.aspx?id="+Eval("wxaid")%> ' class="btn btn-primary btn-table-eidt" title="修改"  data-toggle="tooltip" data-placement="bottom">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                   
                                                      <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("wxaid")%>' CommandName="del"  runat="server"  CssClass="btn btn-danger btn-table-eidt margin-left-20" title="删除"  data-toggle="tooltip" data-placement="bottom"><i class="fa fa-trash"></i> 
                                                      </asp:LinkButton>
