<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="hd_add.aspx.cs" Inherits="DB.Web.Admin.hd_add" %>
                    ...
                    <div class="ibox-content">
                        ...
                        <section class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="date" runat="server" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="num" runat="server" value="0">
                                </div>
                            </div>
                            
                             <div class="form-group">
                                <label class="col-sm-2 control-label">已预约数</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="rnum" runat="server" value="0">
                                </div>
                            </div>
