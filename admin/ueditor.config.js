...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'touppercase', 'tolowercase', 'link', 'unlink', 'simpleupload', 'insertimage','horizontal', '|',
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
            // 'insertvideo', 'music', '|', 
            'searchreplace', 'selectall', 'cleardoc','preview',  
        ]]
		...
		,whitList: {
			...
			hr:     ['class', 'style'],
			i:      ['class', 'style'],
			img:    ['src', 'alt', 'title', 'width', 'height', 'id', '_src', 'loadingclass', 'class', 'data-latex','data-original'],
			ins:    ['datetime'],
			li:     ['class', 'style'],
			mark:   [],
			nav:    ['class', 'style'],
