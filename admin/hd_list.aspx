<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="hd_list.aspx.cs" Inherits="DB.Web.Admin.hd_list" %>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server"   onitemcommand="Repeater1_ItemCommand" >
                                    <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="t-center">
                                                    <a href='<%#"hd_modify.aspx?id="+Eval("did")%> ' class="btn btn-primary btn-table-eidt" title="修改"  data-toggle="tooltip" data-placement="bottom">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                   
                                                      <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("did")%>' CommandName="del"  runat="server"  CssClass="btn btn-danger btn-table-eidt margin-left-20" title="删除"  data-toggle="tooltip" data-placement="bottom"><i class="fa fa-trash"></i> 
                                                      </asp:LinkButton>
