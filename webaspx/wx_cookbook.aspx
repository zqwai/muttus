<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wx_cookbook.aspx.cs" Inherits="DB.Web.wx_cookbook" %>
...
<meta charset="utf-8">
	...
	<title>今日食谱 | mutuus</title>

    <meta name="keywords" content="">
    <meta name="description" content="">

    <link href="css/wx_cookbook.css" rel="stylesheet">

    <script src="js/jquery.1.11.0.min.js"></script>
</head>
<body class="bg_add8df">
...
<ul id="elasticstack" class="elasticstack">
    <li class="flexbox">
        ...
        <article class="cont flex">
            <div class="daytime" runat="server" id="date1"> </div>
            <div class="ncont">
                 <asp:Image ID="Image1" runat="server" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有准备！" />

                <asp:Repeater ID="Repeater1" runat="server"><ItemTemplate>
                    <h5 runat="server" id="H1"><%#Eval("swdx")%></h5>
                    <p runat="server" id="swdt"><%#Eval("swdt")%></p>
        ...
        <footer class="footer clearfix">
            <div class="sign-box">
                <p class="name">
                    <img src="./images/wx/sign-wyl.png" alt="王黎彦">
                </p>
                <div class="sign-text">mutuus联合创始人<br>注册国际营养师(CINM)<br>证书编号：CIN17880D1D</div>
            </div>
            <div class="foot-logo">
    ...
    <li class="flexbox">
        ...
        <article class="cont flex">
            <div class="daytime" runat="server" id="date2"> </div>
            <div class="ncont">
                  <asp:Image ID="Image2" runat="server" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有准备！" />
    ...
    <li class="flexbox">
        ...
        <article class="cont flex">
            <div class="daytime" runat="server" id="date3"> </div>
            <div class="ncont">
               <asp:Image ID="Image3" runat="server" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有准备！" />
    ...
    <li class="flexbox">
        ...
        <article class="cont flex">
            <div class="daytime" runat="server" id="date4"> </div>
            <div class="ncont">

                  <asp:Image ID="Image4" runat="server" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有准备！" />
    ...
    <li class="flexbox">
        ...
        <article class="cont flex">
            <div class="daytime" runat="server" id="date5"> </div>
            <div class="ncont">
                  <asp:Image ID="Image5" runat="server" ImageUrl="images/wx_bg/no.png" CssClass="nofood"  Visible="false" ToolTip="今日没有菜谱！" />
                <asp:Repeater ID="Repeater5" runat="server"><ItemTemplate>
                <h5 runat="server" id="H1"><%#Eval("swdx")%></h5>
                <p runat="server" id="swdt"><%#Eval("swdt")%></p>
                </ItemTemplate></asp:Repeater>
            </div>
    ...
    <script src="js/elastiStack/modernizr.custom.js"></script>
<script src="js/elastiStack/draggabilly.pkgd.min.js"></script>
<script src="js/elastiStack/elastiStack.js"></script>
...
<script>
    ...
    $('.nofood').after('<div class="nofood-text">今日没餐谱哦！</div>');
</script>
</html>
